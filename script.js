// CÓDIGO MODIFICADO PARA DEBUG - Copie e cole isso no seu script.js
document.addEventListener('DOMContentLoaded', () => {
    ...
    function initBotConnection() {
        ...
        es.onopen = () => {
            console.log('[DEBUG] Conexão EventSource ABERTA com o servidor.');
        };
        ...
        es.onmessage = ev => {
            ...
            if (d.type === 'qr') {
                ...
                es.close(); // Fecha a conexão após receber o QR Code
