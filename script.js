document.addEventListener('DOMContentLoaded', () => {
    ...
    const mentoriaData = [
        {
            "moduleId": "MD01", "title": "Módulo 1: Conectando com o Cliente Ideal", "description": "Aprenda a usar o CRM do super app para construir a persona do seu cliente, otimizando seu funil de vendas desde o início.",
            "lessons": [
        ...
        {
            "moduleId": "MD02", "title": "Módulo 2: O Algoritmo da Meta (Facebook & Instagram)", "description": "Entenda como o algoritmo da Meta funciona e aprenda a criar ganchos e conteúdos que direcionam tráfego para o seu super app.",
            "lessons": [
        ...
        {
            "moduleId": "MD03", "title": "Módulo 3: Cronograma de Postagens Estratégico", "description": "Planeje a sua rotina de conteúdo nas redes sociais com um calendário que aumenta o seu alcance e consistência.",
            "lessons": [
        ...
        {
            "moduleId": "MD04", "title": "Módulo 4: Conteúdo que Conecta", "description": "Aprenda a gravar e editar vídeos que engajam, utilizando ferramentas como CapCut e Canva para fortalecer a identidade visual da sua marca.",
            "lessons": [
        ...
        {
            "moduleId": "MD05", "title": "Módulo 5: Copywriting com ChatGPT", "description": "Utilize o ChatGPT para criar textos persuasivos para suas redes sociais e anúncios, usando fórmulas de copy que realmente convertem.",
            "lessons": [
        ...
        {
            "moduleId": "MD06", "title": "Módulo 6: Implementação de CRM", "description": "Organize o relacionamento com seus leads e clientes, e aprenda a fazer remarketing segmentado para vender mais.",
            "lessons": [
        ...
        {
            "moduleId": "MD07", "title": "Módulo 7: Processo Comercial e Técnicas de Venda", "description": "Domine o processo comercial com técnicas de rapport, gatilhos mentais e um pitch de vendas que realmente gera interesse.",
            "lessons": [
        ...
        {
            "moduleId": "MD08", "title": "Módulo 8: Conexão com a Audiência e Humanização", "description": "Construa uma audiência leal ao ser autêntico, mostrar os bastidores e interagir de forma genuína com o seu público.",
            "lessons": [
    ...
    async function loadAllUserData(userId) {
        try {
            ...
            if (doc.exists) {
                ...
                applySettings(); // Aplica configurações padrão se não houver dados
            }
            renderMentoria();
            updateAllUI();
