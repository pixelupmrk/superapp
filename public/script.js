// ====================================================================
// script.js - VERSÃO FINAL E FUNCIONAL (AGORA COM MAIN NO ESCOPO GLOBAL)
// ====================================================================

// --- DADOS COMPLETOS DA MENTORIA (GLOBAL) ---
const mentoriaData = [
...
function setupWhatsappBotConnection() {
    ...
    if (currentUserId) {
        startKeepAlive();
        // ... (A lógica completa do seu setupWhatsappBotConnection original para a aba de status deve vir aqui)
    }
}
...
function setupEventListeners(userId) {
    ...
    // === INICIALIZAÇÃO DA APP (MAIN) - Agora controla o redirecionamento ===
    async function main() {
        ...
        firebase.auth().onAuthStateChanged(async (user) => {
            if (user) {
                ...
                } else if (document.getElementById('app-container') && !document.body.hasAttribute('data-initialized')) {
                    // Se estiver no app e não inicializado, inicia o carregamento dos dados
