...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function setupEventListeners(userId) {
        ...
        document.getElementById('lead-chatbot-form')?.addEventListener('submit', async (e) => {
            ...
            // Remove a necessidade de salvar no chatHistory do objeto principal,
            // pois o bot vai salvar na subcoleção 'messages'.
            ...
            try {
                ...
                // Força a recarga do histórico do Firestore para ver a mensagem enviada
                ...
                // Não precisa salvar o erro no saveUserData, pois o erro é de conexão.
            }
        });
